...
namespace MeShop.Migrations
{
    ...
    [Migration("20240819174806_UpdateDatase9")]
    partial class UpdateDatase9
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MeShop.Models.Order_Detail", b =>
                {
                    b.HasOne("MeShop.Models.Order", "Order")
                        ...
                        .HasForeignKey("MeShop.Models.Order_Detail", "Oder_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MeShop.Models.Payment_Method", "Payment_Method")
